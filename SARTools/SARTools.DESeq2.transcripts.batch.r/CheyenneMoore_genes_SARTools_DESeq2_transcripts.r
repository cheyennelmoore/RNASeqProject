...
workDir <- "~/Git/Project3/SARTools/SARTools.DESeq2.transcripts.batch.r"      # working directory for the R session

projectName <- "SARTools.DESeq2.tanscripts"                         # name of the project
